...
eingesetzt. Wir verwenden dieses Beispiel auch dafür, um verschiedene Reihenfolgen auf der x-Achse bei Balkendiagrammen zu zeigen.

Hier verwenden wir die Daten als erstes Beispiel der Verwendung von ggplot.
...
für die absoluten Häufigkeiten und spielen hier die verschiedenen Sortierungen auf der x-Achse und auch die Möglichkeiten
von ggplot durch.
...
ggsave(filename="familienstand1.png", plot=last_plot(), device="png",
